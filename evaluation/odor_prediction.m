...
odor_list = 1:3; % update this to experiment with different odor lists
noisy_i = 1; % update this to specify which odor to add noise to
...
gaussian_noise = 0.5*randn(1, KC_n);
