...
save('sparsness_fullrandom_localinhibition.mat', 'sparseness');
save('fraction_fullrandom_localinhibition.mat', 'fraction');
save('response_counts_fullrandom_localinhibition.mat', 'response_counts');
