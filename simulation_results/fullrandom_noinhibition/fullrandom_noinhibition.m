...
save('sparseness_fullrandom_noinhibition.mat', 'sparseness');
save('fraction_fullrandom_noinhibition.mat', 'fraction');
save('response_counts_fullrandom_noinhibition.mat', 'response_counts');
% 
